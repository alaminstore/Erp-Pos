                ...
                <div class="zalopo_sid_style text-center">
                    ...
                    @if($stockin)
                        @foreach($stockin as $stock)
                            <p><b>System Id:</b> {{$stock->system}}</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table">
                            ...
                            <tbody>
                            @if($stockin_details)
                                @foreach($stockin_details as $details)
                                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="bg">{{$stockin_details->sum('booking_qty')}}</td>
                                    <td class="bg">{{$stockin_details->sum('receiving_qty')}}</td>
                                   <td></td>
                                    <td></td>
